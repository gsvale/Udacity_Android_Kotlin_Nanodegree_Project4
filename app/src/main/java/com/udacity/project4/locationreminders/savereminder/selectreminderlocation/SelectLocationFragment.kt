...
class SelectLocationFragment : BaseFragment(), OnMapReadyCallback {
    ...
    // Variables and methods related to permissions needed for user location and geofencing
...
//            }
    ...
    private fun onPermissionsApproved() {
        ...
        // Add marker to location that the user selected
        ...
        // Call this function after user confirms on the selected location
    ...
    private fun onLocationSelected() {
        // When user confirms the selected location send back to previous fragment
        if (currentPoi != null) {
